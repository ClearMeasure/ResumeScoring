...
**wordGroup:** A collection of words to apply to a resume.  As each word is ran through a regex, the comma delimitted grouping of characters could just as easily be a valid expression.  ORing and ANDing of words should in theory work for free. (this is untested as of yet)
